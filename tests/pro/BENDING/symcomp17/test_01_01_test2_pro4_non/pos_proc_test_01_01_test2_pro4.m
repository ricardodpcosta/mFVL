...
p2_pro4=format_errors_orders(error{1,1},numel(num_cells),num_cells);

p2_pro4_l1=format_errors_orders(error{2,1},numel(num_cells),num_cells);
...
%    p3_pro4_l1.e,p3_pro4_l1.o,...
%    p4_pro4_l1.e,p4_pro4_l1.o);
save('output/test_pro_bending_01_01_test2_pro4_results','p2_pro4','p2_pro4_l1');
