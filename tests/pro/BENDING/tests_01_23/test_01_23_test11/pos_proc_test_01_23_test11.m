...
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output\test_pro_bending_01_23_test11_results.mat');
...
directory1='..\..\..\..\..\Report\BIC_2017_report\tables\bending_pro_tables\test_01_23_test11.tex';
directory2='output\test_01_23_test11.tex';
caption='Numerical results of the example~\ref{Example:Pro:bending:Test01_23_glob1} with $\omega=1|3$, and $\omega=3$.';
 ...
 mfvl_write_table4(directory2,caption,label,num_cells,degree,...
     ...
     P8_PRO1.e,P8_PRO1.o,...
     P9_PRO1.e,P9_PRO1.o);
save('output\test_pro_bending_01_23_test11_results.mat');
