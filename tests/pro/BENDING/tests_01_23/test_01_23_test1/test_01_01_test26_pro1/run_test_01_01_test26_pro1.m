...
mfvl_lib;
global a_matrix_point_value_1;
global a_matrix_mean_value_1_cell;
global a_matrix_mean_value_last_cell;
global a_matrix_point_value_last_vertex;
...
for d=1:numel(degree)
        for k=1:numel(num_cells)
            geo_test_01_01_test26_pro1;
            model_test_01_01_test26_pro1;
            mesh_test_01_01_test26_pro1;
            disp([d k]); 
            ...
            a_matrix_point_value_1=[];
            a_matrix_mean_value_1_cell=[];
            a_matrix_mean_value_last_cell=[];
            a_matrix_point_value_last_vertex=[];
        end
end

% work files
save('output/test_pro_bending_01_01_test26_pro1_results.mat');
load gong.mat;
sound(y);
