...
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_01_23_test5_pro1_results.mat');
...
% write tables
label='Table:PRO:test_01_23_test5_pro1';
directory1='../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_01_23_test5_pro1.tex';
directory2='output/test_01_23_test5_pro1.tex';
caption='Numerical results of the example~/ref{Example:Pro:bending:Test01_23_pro1} with $/omega=1|1$, and $/omega=1$.';
 ...
 mfvl_write_table4(directory2,caption,label,num_cells,degree,...
     p1_pro1.e,p1_pro1.o,...
     p2_pro1.e,p2_pro1.o);
save('output/test_pro_bending_01_23_test5_pro1_results.mat');
