...
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output\test_pro_bending_01_01_test14_results.mat');
...
directory1='..\..\..\..\..\Report\BIC_2017_report\tables\bending_pro_tables\test_01_01_test14.tex';
directory2='output\test_01_01_test14.tex';
...
mfvl_write_table4(directory2,caption,label,num_cells,degree,...
    ...
    P5_PRO1.e,P5_PRO1.o,...
    P6_PRO1.e,P6_PRO1.o);
save('output\test_pro_bending_01_01_test14_results.mat');
