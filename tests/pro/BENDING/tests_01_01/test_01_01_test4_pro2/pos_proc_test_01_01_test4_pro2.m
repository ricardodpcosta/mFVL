...
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_01_01_test4_pro2_results.mat');
...
p8_pro2=format_errors_orders(error{2}(:,1),numel(num_cells),num_cells);

% write tables
label='Table:pRO:test_01_01_test4_pro2';
directory1='../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_01_01_test4_pro2.tex';
directory2='output/test_01_01_test4_pro2.tex';
...
mfvl_write_table4(directory2,caption,label,num_cells,degree,...
    p7_pro2.e,p7_pro2.o,...
    p8_pro2.e,p8_pro2.o);
save('output/test_pro_bending_01_01_test4_pro2_results.mat');
