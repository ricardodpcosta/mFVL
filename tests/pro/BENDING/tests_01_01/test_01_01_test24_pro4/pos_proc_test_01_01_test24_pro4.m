...
addpath('../../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_01_01_test24_pro4_results.mat');
...
p4_pro4=format_errors_orders(error{1},numel(num_cells),num_cells);
p5_pro4=format_errors_orders(error{2},numel(num_cells),num_cells);
p6_pro4=format_errors_orders(error{3},numel(num_cells),num_cells);

if ~exist('output/tables', 'dir')
    mkdir('output/','tables');
end
% write tables
label='Table:PRO:test_01_01_test24_pro4';
directory1='../../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_01_01_test24_pro4.tex';
directory2='output/tables/test_01_01_test24_pro4.tex';
