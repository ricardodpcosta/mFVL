...
addpath('../../../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_01_01_test25_pro6_results.mat');
...
p7_pro6=format_errors_orders(error{1},numel(num_cells),num_cells);
p8_pro6=format_errors_orders(error{2},numel(num_cells),num_cells);
p9_pro6=format_errors_orders(error{3},numel(num_cells),num_cells);

if ~exist('output/tables', 'dir')
    mkdir('output/','tables');
end
% write tables
label='Table:PRO:test_01_01_test25_pro6';
directory1='../../../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_01_01_test25_pro6.tex';
directory2='output/tables/test_01_01_test25_pro6.tex';
...
%     p5_pro6.e,p5_pro6.o,...
%     p6_pro6.e,p6_pro6.o);
save('output/test_pro_bending_01_01_test25_pro6_results.mat');
