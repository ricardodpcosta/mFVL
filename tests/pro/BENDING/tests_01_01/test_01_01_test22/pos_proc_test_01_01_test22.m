...
addpath('../../../../mfvl_utils_mod/results_treatment');
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output\test_pro_bending_01_01_test22_results.mat');
...
% P10_PRO2=format_errors_orders(error{1}(:,2),numel(num_cells),num_cells);
% P11_PRO2=format_errors_orders(error{2}(:,2),numel(num_cells),num_cells);
% P12_PRO2=format_errors_orders(error{3}(:,2),numel(num_cells),num_cells);

% write tables
label='Table:PRO:test_01_01_test22';
directory1='..\..\..\..\..\Report\BIC_2017_report\tables\bending_pro_tables\test_01_01_test22.tex';
directory2='output\test_01_01_test22.tex';
...
%     P10_PRO2.e,P10_PRO2.o,...
%     P11_PRO1.e,P11_PRO1.o,...
%     P11_PRO2.e,P11_PRO2.o,...
%     P12_PRO1.e,P12_PRO1.o,...
%     P12_PRO2.e,P12_PRO2.o);
...
%    P11_PRO1.e,P11_PRO1.o,...
%    P12_PRO1.e,P12_PRO1.o);
save('output\test_pro_bending_01_01_test22_results.mat');
