...
addpath('../test_01_01_test3_pro2_con/output');
...
addpath('../test_01_01_test4_pro2_con/output');
...
addpath('../test_01_01_test3_pro7_con/output');
load('test_pro_bending_01_01_test3_pro7_results');
p3_l_inf=p1_pro7;
p3_l_1=p1_pro7_l1;
...
addpath('../test_01_01_test4_pro7_con/output');
load('test_pro_bending_01_01_test4_pro7_results');
p4_l_inf=p4_pro7;
p4_l_1=p4_pro7_l1;
...
file_name_out='table_01_01_test3_4_con_pro2_7.tex';
caption_table='Test of 01\_01 with d and d+1 ($\exp(x)+\mathbb{P}_3$).';
label='none';
