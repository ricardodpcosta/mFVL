...
p3_pro4=format_errors_orders(error{1,1},numel(num_cells),num_cells);
p3_pro4_l1=format_errors_orders(error{2,1},numel(num_cells),num_cells);

p4_pro4=format_errors_orders(error{1,2},numel(num_cells),num_cells);
p4_pro4_l1=format_errors_orders(error{2,2},numel(num_cells),num_cells);

save('output/test_pro_bending_01_01_test4_pro4_results','p3_pro4','p3_pro4_l1','p4_pro4','p4_pro4_l1');
