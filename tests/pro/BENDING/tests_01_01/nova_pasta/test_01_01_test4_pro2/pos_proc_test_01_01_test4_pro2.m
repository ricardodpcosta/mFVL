...
p3_pro2_l1=format_errors_orders(error{2,1},numel(num_cells),num_cells);

p4_pro2=format_errors_orders(error{1,2},numel(num_cells),num_cells);
p4_pro2_l1=format_errors_orders(error{2,2},numel(num_cells),num_cells);

save('output/test_pro_bending_01_01_test4_pro2_results','p3_pro2','p3_pro2_l1','p4_pro2','p4_pro2_l1');
