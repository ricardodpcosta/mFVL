...
p1_pro7=format_errors_orders(error{1,1},numel(num_cells),num_cells);
p1_pro7_l1=format_errors_orders(error{2,1},numel(num_cells),num_cells);

p2_pro7=format_errors_orders(error{1,2},numel(num_cells),num_cells);
p2_pro7_l1=format_errors_orders(error{2,2},numel(num_cells),num_cells);

p3_pro7=format_errors_orders(error{1,3},numel(num_cells),num_cells);
p3_pro7_l1=format_errors_orders(error{2,3},numel(num_cells),num_cells);

%if ~exist('output/tables', 'dir')
%    mkdir('output/','tables');
%end
% write tables
%label='Table:PRO:test_01_01_test5_pro7';
%directory1='../../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_01_01_test5_pro7.tex';
%directory2='output/tables/test_01_01_test5_pro7.tex';
%directory3='output/tables/test_01_01_test5_pro7_l1.tex';
...
%    p1_pro7_l1.e,p1_pro7_l1.o,...
%    p2_pro7_l1.e,p2_pro7_l1.o);
save('output/test_pro_bending_01_01_test5_pro7_results','p1_pro7','p1_pro7_l1','p2_pro7','p2_pro7_l1','p3_pro7','p3_pro7_l1');
