...
p7_pro2=format_errors_orders(error{1,1},numel(num_cells),num_cells);
p7_pro2_l1=format_errors_orders(error{2,1},numel(num_cells),num_cells);

p8_pro2=format_errors_orders(error{1,2},numel(num_cells),num_cells);
p8_pro2_l1=format_errors_orders(error{2,2},numel(num_cells),num_cells);

p9_pro2=format_errors_orders(error{1,3},numel(num_cells),num_cells);
p9_pro2_l1=format_errors_orders(error{2,3},numel(num_cells),num_cells);

save('output/test_pro_bending_02_02_test1_pro2_results','p7_pro2','p7_pro2_l1','p8_pro2','p8_pro2_l1','p9_pro2','p9_pro2_l1');
