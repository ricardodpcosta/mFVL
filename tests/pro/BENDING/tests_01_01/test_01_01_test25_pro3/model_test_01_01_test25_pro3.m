...
bc_left=mfvl_bound_cond1d('type01',[0 6*pi],ph1,'bc1');
bc_right=mfvl_bound_cond1d('type01',[0 6*exp(1)*pi],ph2,'bc2');
% source_term
f_term=@(x)exp(x)*(24*pi*(36*pi^2-1)*cos(6*pi*x)-(1296*pi^4-216*pi^2+1)*sin(6*pi*x));
