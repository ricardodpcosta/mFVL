...
addpath('../../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_01_01_test29_pro2_results.mat');
func=@(x)sin(pi*x); % attention
% errors
...
% write tables
label='Table:PRO:test_01_01_test29_pro2';
directory1='../../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_01_01_test29_pro2.tex';
directory2='output/tables/test_01_01_test29_pro2.tex';
...
%     p5_pro2.e,p5_pro2.o,...
%     p6_pro2.e,p6_pro2.o);
save('output/test_pro_bending_01_01_test29_pro2_results.mat');
