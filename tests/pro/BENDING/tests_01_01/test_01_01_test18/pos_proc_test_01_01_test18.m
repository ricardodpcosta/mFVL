...
addpath('../../../../mfvl_utils_mod/results_treatment');
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output\test_pro_bending_01_01_test18_results.mat');
...
P16_PRO1=format_errors_orders(error{1}(:,1),numel(num_cells),num_cells);
P17_PRO1=format_errors_orders(error{2}(:,1),numel(num_cells),num_cells);
P18_PRO1=format_errors_orders(error{3}(:,1),numel(num_cells),num_cells);
% P16_PRO2=format_errors_orders(error{1}(:,2),numel(num_cells),num_cells);
% P17_PRO2=format_errors_orders(error{2}(:,2),numel(num_cells),num_cells);
% P18_PRO2=format_errors_orders(error{3}(:,2),numel(num_cells),num_cells);

% write tables
label='Table:PRO:test_01_01_test18';
directory1='..\..\..\..\..\Report\BIC_2017_report\tables\bending_pro_tables\test_01_01_test18.tex';
directory2='output\test_01_01_test18.tex';
...
%     P16_PRO1.e,P16_PRO1.o,...
%     P16_PRO2.e,P16_PRO2.o,...
%     P17_PRO1.e,P17_PRO1.o,...
%     P17_PRO2.e,P17_PRO2.o,...
%     P18_PRO1.e,P18_PRO1.o,...
%     P18_PRO2.e,P18_PRO2.o);
...
mfvl_write_table4(directory2,caption,label,num_cells,degree,...
    ...
    P17_PRO1.e,P17_PRO1.o,...
    P18_PRO1.e,P18_PRO1.o);
save('output\test_pro_bending_01_01_test18_results.mat');
