...
addpath('../../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_01_01_test26_pro2_results.mat');
...
p10_pro2=format_errors_orders(error{1},numel(num_cells),num_cells);
p11_pro2=format_errors_orders(error{2},numel(num_cells),num_cells);
p12_pro2=format_errors_orders(error{3},numel(num_cells),num_cells);

if ~exist('output/tables', 'dir')
    mkdir('output/','tables');
end
% write tables
label='Table:PRO:test_01_01_test26_pro2';
directory1='../../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_01_01_test26_pro2.tex';
directory2='output/tables/test_01_01_test26_pro2.tex';
...
%     p7_pro2.e,p7_pro2.o,...
%     p8_pro2.e,p8_pro2.o);
save('output/test_pro_bending_01_01_test26_pro2_results.mat');
