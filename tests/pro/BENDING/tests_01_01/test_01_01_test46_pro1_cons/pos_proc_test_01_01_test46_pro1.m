...
func=@(x)(-exp(x)-(exp(1)-3)*x^3-(5-2*exp(1))*x^2+1); % attention
% errors
...
directory1='../../../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_01_01_test46_pro1_cons.tex';
directory2='output/tables/test_01_01_test46_pro1_cons.tex';
...
mfvl_write_table4(directory2,caption,label,num_cells,degree,...
    p7_pro1.e,p7_pro1.o,...
    p8_pro1.e,p8_pro1.o);
save('output/test_pro_bending_01_01_test46_pro1_results','p7_pro1','p8_pro1');
