...
addpath('../../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_01_01_test25_pro2_results.mat');
...
p9_pro2=format_errors_orders(error{3},numel(num_cells),num_cells);

if ~exist('output/tables', 'dir')
    mkdir('output/','tables');
end
% write tables
label='Table:PRO:test_01_01_test25_pro2';
directory1='../../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_01_01_test25_pro2.tex';
directory2='output/tables/test_01_01_test25_pro2.tex';
...
%     p5_pro2.e,p5_pro2.o,...
%     p6_pro2.e,p6_pro2.o);
save('output/test_pro_bending_01_01_test25_pro2_results.mat');
