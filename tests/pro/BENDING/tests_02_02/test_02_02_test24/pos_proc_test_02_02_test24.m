...
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output\test_pro_bending_02_02_test24_results.mat');
...
directory1='..\..\..\..\..\Report\BIC_2017_report\tables\bending_pro_tables\test_02_02_test24.tex';
directory2='output\test_02_02_test24.tex';
caption='Numerical results of the example~\ref{Example:Pro:bending:Test02_02_glob1} with $\omega=1|3$, and $\omega=10$.';
 ...
 mfvl_write_table4(directory2,caption,label,num_cells,degree,...
     ...
     P11_PRO1.e,P11_PRO1.o,...
     P12_PRO1.e,P12_PRO1.o);
save('output\test_pro_bending_02_02_test24_results.mat');
