...
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_02_02_test22_pro3_results.mat');
...
p3_pro3=format_errors_orders(error{1}(:,1),numel(num_cells),num_cells);
p4_pro3=format_errors_orders(error{2}(:,1),numel(num_cells),num_cells);

% write tables
label='Table:PRO:test_02_02_test22_pro3';
directory1='../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_02_02_test22_pro3.tex';
directory2='output/test_02_02_test22_pro3.tex';
caption='Numerical results of the example~/ref{Example:Pro:bending:Test02_02_glob6_pro3} with $/omega=1|3$, and $/omega=1$.';
 ...
 mfvl_write_table4(directory2,caption,label,num_cells,degree,...
     p3_pro3.e,p3_pro3.o,...
     p4_pro3.e,p4_pro3.o);
save('output/test_pro_bending_02_02_test22_pro3_results.mat');
