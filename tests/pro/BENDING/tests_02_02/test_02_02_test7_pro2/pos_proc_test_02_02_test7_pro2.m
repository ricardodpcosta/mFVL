...
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_02_02_test7_pro2_results.mat');
...
% write tables
label='Table:PRO:test_02_02_test7_pro2';
directory1='../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_02_02_test7_pro2.tex';
directory2='output/test_02_02_test7_pro2.tex';
caption='Numerical results of the example~/ref{Example:Pro:bending:Test02_02_pro2} with $/omega=1|3$, and $/omega=3$.';
 ...
 mfvl_write_table4(directory2,caption,label,num_cells,degree,...
     p5_pro2.e,p5_pro2.o,...
     p6_pro2.e,p6_pro2.o);
save('output/test_pro_bending_02_02_test7_pro2_results.mat');
