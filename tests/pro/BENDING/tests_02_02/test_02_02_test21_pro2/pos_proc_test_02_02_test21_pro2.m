...
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_02_02_test21_pro2_results.mat');
...
p2_pro2=format_errors_orders(error{2}(:,1),numel(num_cells),num_cells);

% write tables
label='Table:PRO:test_02_02_test21_pro2';
directory1='../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_02_02_test21_pro2.tex';
directory2='output/test_02_02_test21_pro2.tex';
caption='Numerical results of the example~/ref{Example:Pro:bending:Test02_02_glob6_pro2} with $/omega=1|1$, and $/omega=1$.';
 ...
 mfvl_write_table4(directory2,caption,label,num_cells,degree,...
     p1_pro2.e,p1_pro2.o,...
     p2_pro2.e,p2_pro2.o);
save('output/test_pro_bending_02_02_test21_pro2_results.mat');
