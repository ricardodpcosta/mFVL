...
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output\test_pro_bending_02_02_test18_results.mat');
...
% write tables
label='Table:PRO:test_02_02_test18';
directory1='..\..\..\..\..\Report\BIC_2017_report\tables\bending_pro_tables\test_02_02_test18.tex';
directory2='output\test_02_02_test18.tex';
caption='Numerical results of the example~\ref{Example:Pro:bending:Test02_02_glob1} with $\omega=1|3$, and $\omega=1$.';
 ...
 mfvl_write_table4(directory2,caption,label,num_cells,degree,...
     ...
     P5_PRO1.e,P5_PRO1.o,...
     P6_PRO1.e,P6_PRO1.o);
save('output\test_pro_bending_02_02_test18_results.mat');
