...
addpath('../../../../mfvl_utils_mod/results_treatment');
load('output/test_pro_bending_02_02_test10_pro1_results.mat');
...
directory1='../../../../../Report/BIC_2017_report/tables/bending_pro_tables/test_02_02_test10_pro1.tex';
directory2='output/test_02_02_test10_pro1.tex';
caption='Numerical results of the example~/ref{Example:Pro:bending:Test02_02_glob3_pro1} with $/omega=1|3$, and $/omega=1$.';
 ...
 mfvl_write_table4(directory2,caption,label,num_cells,degree,...
     p3_pro1.e,p3_pro1.o,...
     p4_pro1.e,p4_pro1.o);
save('output/test_pro_bending_02_02_test10_pro1_results.mat');
