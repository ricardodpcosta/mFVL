...
stencil_size(2,:)=degree+repmat(2,1,numel(degree));
stencil_size(3,:)=degree+repmat(2,1,numel(degree));
stencil_size(4,:)=degree+repmat(3,1,numel(degree));
...
% work files
save('output\test16_pro_results.mat');
load gong.mat;
sound(y);