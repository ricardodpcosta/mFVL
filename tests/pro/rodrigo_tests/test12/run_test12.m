...
stencil_size(2,:)=degree+ones([1 numel(degree)]);
stencil_size(3,:)=degree+ones([1 numel(degree)]);
stencil_size(4,:)=degree+repmat(2,1,numel(degree));
...
% work files
save('output\test12_pro_results.mat');
load gong.mat;
sound(y);