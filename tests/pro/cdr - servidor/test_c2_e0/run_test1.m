% November, 2017
% script for processing for test with c2 and e=0 - PRO
clear all; clc;
addpath('../../../../');
    ...
    for d=1:numel(degree)
        for f=1:numel(flux_num)
            ...
            for k=1:numel(num_cells)
                ...
                pro{j}{d}{k,f}=mfvl_pro_cdr_25_07_17(mesh,domain,mod,degree(d),flux,[weight1 weight2],stencil_size(:,d),auto_stencil_opt);
