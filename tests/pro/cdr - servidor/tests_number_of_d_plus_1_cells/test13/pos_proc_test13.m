...
% write tables
label='Table:PRO:Test13';
%directory1='../../../../Report/BIC_2017_report/tables/new_pro_tables/new.tex';
directory2='output/tables/test_13.tex';
%directory3='output/tables/uniform_0_d_dir.tex';
caption='Numerical results of pure diffusion for $\phi(x)=\exp(x)$, $\kappa(x)=1$, and $u(x)=0$ (Neumann bc and 12 cells with $d+1$  and the other cells with $d$).';
