...
directory2='output/tables/test_7.tex';
%directory3='output/tables/uniform_0_d_dir.tex';
caption='Numerical results of pure diffusion for $\phi(x)=\exp(x)$, $\kappa(x)=1$, and $u(x)=0$ (Neumann bc and 6 cells with $d+1$  and the other cells with $d$).';
