...
%%%%
write_table_0('results_alpha_0_E0O0_x5_dir.tex','Results of the reconstruction in the Dirichlet B. ($\alpha$=0); $\phi(x)=x^5$.',xf,...
...
write_table_1('results_alpha_0_E1O1_x5_dir.tex','Results of the reconstruction in the Dirichlet B. - derivative ($\alpha$=0); $\phi(x)=x^5$.',xf,...
...
%%%%
write_table_0('results_alpha_h_E0O0_x5_dir.tex','Results of the reconstruction in the Dirichlet B. ($\alpha=h$); $\phi(x)=x^5$.',xf,...
...
write_table_1('results_alpha_h_E1O1_x5_dir.tex','Results of the reconstruction in the Dirichlet B. - derivative ($\alpha=h$); $\phi(x)=x^5$.',xf,...
...
%%%%
write_table_0('results_alpha_05_E0O0_x5_dir.tex','Results of the reconstruction in the Dirichlet B. ($\alpha=0.5$); $\phi(x)=x^5$.',xf,...
...
write_table_1('results_alpha_05_E1O1_x5_dir.tex','Results of the reconstruction in the Dirichlet B. - derivative ($\alpha=0.5$); $\phi(x)=x^5$.',xf,...
