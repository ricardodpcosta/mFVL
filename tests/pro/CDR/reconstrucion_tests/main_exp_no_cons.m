...
%%%%
write_table_0('results_alpha_0_E0O0_exp_no_conservation.tex','Results of the reconstruction without restriction; $\phi(x)=\exp(x)$.',xf,...
...
write_table_1('results_alpha_0_E1O1_exp_no_conservation.tex','Results of the reconstruction without restriction; $\phi(x)=\exp(x)$.',xf,...
