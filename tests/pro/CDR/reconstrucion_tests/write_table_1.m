function write_table_1(file_name_out,caption_table,xf,E1,O1,E2,O2,E3,O3,E4,O4,E5,O5)
...
fprintf(fid,' & E$_{1,\\infty}$ & O$_{1,\\infty}$ & & E$_{1,\\infty}$ & O$_{1,\\infty}$ & & E$_{1,\\infty}$ & O$_{1,\\infty}$ & & E$_{1,\\infty}$ & O$_{1,\\infty}$ & & E$_{1,\\infty}$ & O$_{1,\\infty}$\\\\\n');
fprintf(fid,'\\midrule\n');
%%%%%
for i=1:numel(xf)
