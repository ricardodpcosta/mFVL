...
%%%%
write_table_0('results_alpha_0_E0O0_1x5_neu.tex','Results of the reconstruction in the Neumann B. ($\alpha$=0); $\phi(x)=(1+x)^5$.',xf,...
...
write_table_1('results_alpha_0_E1O1_1x5_neu.tex','Results of the reconstruction in the Neumann B. - derivative ($\alpha$=0); $\phi(x)=(1+x)^5$.',xf,...
...
%%%%
write_table_0('results_alpha_h_E0O0_1x5_neu.tex','Results of the reconstruction in the Neumann B. ($\alpha=h$); $\phi(x)=(1+x)^5$.',xf,...
...
write_table_1('results_alpha_h_E1O1_1x5_neu.tex','Results of the reconstruction in the Neumann B. - derivative ($\alpha=h$); $\phi(x)=(1+x)^5$.',xf,...
...
%%%%
write_table_0('results_alpha_05_E0O0_1x5_neu.tex','Results of the reconstruction in the Neumann B. ($\alpha=0.5$); $\phi(x)=(1+x)^5$.',xf,...
...
write_table_1('results_alpha_05_E1O1_1x5_neu.tex','Results of the reconstruction in the Neumann B. - derivative ($\alpha=0.5$); $\phi(x)=(1+x)^5$.',xf,...
