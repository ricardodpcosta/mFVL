...
for j=1:numel(d)
    ...
    for i=1:numel(xf)
        xff=xf(i);
        alpha=0;
        R_0{j}(i,1)=dirichlet_conservation(xi,xff,d(j),m,func,func_der,alpha,xi);
...
for j=1:numel(d)
    ...
    for i=1:numel(xf)
        xff=xf(i);
        alpha=(xff-xi)/m;
        R_h{j}(i,1)=dirichlet_conservation(xi,xff,d(j),m,func,func_der,alpha,xi);
...
for j=1:numel(d)
    ...
    for i=1:numel(xf)
        ...
        hs(i,j)=(xff-xi)/m;
        alpha=0.5;
        R_05{j}(i,1)=dirichlet_conservation(xi,xff,d(j),m,func,func_der,alpha,xi);
...
%%%%
write_table_0('results_alpha_0_E0O0_1x5_dir.tex','Results of the reconstruction in the Dirichlet B. ($\alpha$=0); $\phi(x)=(1+x)^5$.',xf,...
...
write_table_1('results_alpha_0_E1O1_1x5_dir.tex','Results of the reconstruction in the Dirichlet B. - derivative ($\alpha$=0); $\phi(x)=(1+x)^5$.',xf,...
...
%%%%
write_table_0('results_alpha_h_E0O0_1x5_dir.tex','Results of the reconstruction in the Dirichlet B. ($\alpha=h$); $\phi(x)=(1+x)^5$.',xf,...
...
write_table_1('results_alpha_h_E1O1_1x5_dir.tex','Results of the reconstruction in the Dirichlet B. - derivative ($\alpha=h$); $\phi(x)=(1+x)^5$.',xf,...
...
%%%%
write_table_0('results_alpha_05_E0O0_1x5_dir.tex','Results of the reconstruction in the Dirichlet B. ($\alpha=0.5$); $\phi(x)=(1+x)^5$.',xf,...
...
write_table_1('results_alpha_05_E1O1_1x5_dir.tex','Results of the reconstruction in the Dirichlet B. - derivative ($\alpha=0.5$); $\phi(x)=(1+x)^5$.',xf,...
