...
%%%%
write_table_0('results_alpha_0_E0O0_x2_no_conservation.tex','Results of the reconstruction without restriction; $\phi(x)=x^2$.',xf,...
...
write_table_1('results_alpha_0_E1O1_x2_no_conservation.tex','Results of the reconstruction without restriction; $\phi(x)=x^2$.',xf,...
