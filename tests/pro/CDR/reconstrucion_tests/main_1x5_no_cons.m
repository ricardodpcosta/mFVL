...
%%%%
write_table_0('results_alpha_0_E0O0_1x5_no_conservation.tex','Results of the reconstruction without restriction; $\phi(x)=(1+x)^5$.',xf,...
...
write_table_1('results_alpha_0_E1O1_1x5_no_conservation.tex','Results of the reconstruction without restriction; $\phi(x)=(1+x)^5$.',xf,...
