    ...
    for d=1:numel(degree)
        for f=1:numel(flux_num)
            ...
            for k=1:numel(num_cells)
                ...
                domain.point(2).coord=domain.point(2).coord+0*(1/num_cells(k))/2;
                model_test1;
                ...
                pro{j}{d}{k,f}=mfvl_pro_cdr_25_07_17_c1(mesh,domain,mod,degree(d),flux,[weight1 weight2],stencil_size(:,d),auto_stencil_opt);
