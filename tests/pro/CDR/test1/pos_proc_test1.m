...
%                 f_diff = mfvl_exact_flux_diff_pro2_cdr(@(x)exp(x),vertices_coordinates,...
%                     pro_s.model.material.thermal_conductivity(vertices_coordinates));
%                 f_conv = mfvl_exact_flux_conv_pro2_cdr(func,vertices_coordinates,pro_s.model.velocity(vertices_coordinates));
...
directory2='output/tables/results/tables/uniform_h_over_2_5d+1.tex';
...
mfvl_write_table13(directory2,caption,label,num_cells,degree,condition,...
    P1_L1.e,P1_L1.o,P1.e,P1.o,...
    P2_L1.e,P2_L1.o,P2.e,P2.o,...
    P3_L1.e,P3_L1.o,P3.e,P3.o,...
    P4_L1.e,P4_L1.o,P4.e,P4.o,...
    P5_L1.e,P5_L1.o,P5.e,P5.o);
