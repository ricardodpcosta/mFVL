function mfvl_symcomp_tables_01_23(file_name_out,caption_table,label,num_cells,degree,p1_l_inf,p1_l_1,...
    p2_l_inf,p2_l_1,p3_l_inf,p3_l_1,p4_l_inf,p4_l_1,p5_l_inf,p5_l_1,p6_l_inf,p6_l_1,...
    p7_l_inf,p7_l_1,p8_l_inf,p8_l_1)
...
fprintf(fid,'\\midrule\n');
fprintf(fid,'\\multirow{%d}{*}{$\\mathbb{P}_{%d}$(d/d)}\n & %d & %s & %s  & %s & %s &  & %s & %s & %s & %s\\\\\n',...
...
fprintf(fid,'\\midrule\n');
%%%
fprintf(fid,'\\multirow{%d}{*}{$\\mathbb{P}_{%d}$(d+1/d+1)}\n & %d & %s & %s  & %s & %s &  & %s & %s & %s & %s\\\\\n',...
    numel(num_cells),degree(1),num_cells(1),...
    p3_1_e{1},p3_1_o{1},...
...
% fprintf(fid,'\\midrule\n');
%%%
% fprintf(fid,'\\multirow{%d}{*}{$\\mathbb{P}_{%d}$(d+1/d+2)}\n & %d & %s & %s  & %s & %s &  & %s & %s & %s & %s\\\\\n',...
%     numel(num_cells),degree(1),num_cells(1),...
%     p5_1_e{1},p5_1_o{1},...
...
% fprintf(fid,'\\midrule\n');
%%%
% fprintf(fid,'\\multirow{%d}{*}{$\\mathbb{P}_{%d}$(d+1/d+3)}\n & %d & %s & %s  & %s & %s &  & %s & %s & %s & %s\\\\\n',...
%     numel(num_cells),degree(1),num_cells(1),...
%     p7_1_e{1},p7_1_o{1},...
