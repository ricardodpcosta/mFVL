function mfvl_write_table11(file_name_out,caption_table,label,num_cells,degree,p1_l_inf,p1_l_1,...
...
p9_1_o=p9_l_1.o;
%
p10_inf_e=p10_l_inf.e;
p10_inf_o=p10_l_inf.o;

p10_1_e=p10_l_1.e;
p10_1_o=p10_l_1.o;
%
p11_inf_e=p11_l_inf.e;
p11_inf_o=p11_l_inf.o;

p11_1_e=p11_l_1.e;
p11_1_o=p11_l_1.o;
%
p12_inf_e=p12_l_inf.e;
p12_inf_o=p12_l_inf.o;
...
fprintf(fid,'\\midrule\n');
%%%
fprintf(fid,'\\multirow{%d}{*}{$\\mathbb{P}_{%d}/\\mathbb{P}_{5}$}\n & %d & %s & %s  & %s & %s &  & %s & %s & %s & %s\\\\\n',...
    numel(num_cells),degree(2),num_cells(1),...
    p7_1_e{1},p7_1_o{1},...
...
%%%
fprintf(fid,'\\multirow{%d}{*}{$\\mathbb{P}_{%d}$}\n & %d & %s & %s  & %s & %s &  & %s & %s & %s & %s\\\\\n',...
    numel(num_cells),degree(3),num_cells(1),...
    p9_1_e{1},p9_1_o{1},...
    p9_inf_e{1},p9_inf_o{1},...
    p10_1_e{1},p10_1_o{1},...
    p10_inf_e{1},p10_inf_o{1});
for i=2:numel(num_cells)
    fprintf(fid,' & %d & %s & %s  & %s & %s &  & %s & %s & %s & %s\\\\\n',...
    num_cells(i),...
    p9_1_e{i},p9_1_o{i},...
    p9_inf_e{i},p9_inf_o{i},...
    p10_1_e{i},p10_1_o{i},...
    p10_inf_e{i},p10_inf_o{i});
end
fprintf(fid,'\\midrule\n');
%%%
fprintf(fid,'\\multirow{%d}{*}{$\\mathbb{P}_{%d}/\\mathbb{P}_{6}$}\n & %d & %s & %s  & %s & %s &  & %s & %s & %s & %s\\\\\n',...
    numel(num_cells),degree(3),num_cells(1),...
    p11_1_e{1},p11_1_o{1},...
    p11_inf_e{1},p11_inf_o{1},...
    p12_1_e{1},p12_1_o{1},...
    p12_inf_e{1},p12_inf_o{1});
for i=2:numel(num_cells)
    fprintf(fid,' & %d & %s & %s  & %s & %s &  & %s & %s & %s & %s\\\\\n',...
    num_cells(i),...
    p11_1_e{i},p11_1_o{i},...
    p11_inf_e{i},p11_inf_o{i},...
    p12_1_e{i},p12_1_o{i},...
    p12_inf_e{i},p12_inf_o{i});
end
