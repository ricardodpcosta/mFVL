...
for i=2:numel(num_cells)
    fprintf(fid,' & %d & %s & %s &  & %s & %s &  & %s & %s &  & %s & %s\\\\\n',...
        num_cells(i),...
        P1_E{i},P1_O{i},P4_E{i},P4_O{i},P7_E{i},P7_O{i},P10_E{i},P10_O{i});
end
...
for i=2:numel(num_cells)
    fprintf(fid,' & %d & %s & %s &  & %s & %s &  & %s & %s &  & %s & %s\\\\\n',...
        num_cells(i),...
        P2_E{i},P2_O{i},P5_E{i},P5_O{i},P8_E{i},P8_O{i},P11_E{i},P11_O{i});
end
fprintf(fid,'\\midrule\n');
...
for i=2:numel(num_cells)
    fprintf(fid,' & %d & %s & %s &  & %s & %s &  & %s & %s &  & %s & %s\\\\\n',...
        num_cells(i),...
        P3_E{i},P3_O{i},P6_E{i},P6_O{i},P9_E{i},P9_O{i},P12_E{i},P12_O{i});
end
