% January, 2017
% class for mfvl_pro
classdef mfvl_pro_cdr_11<handle
    ...
    methods
        ...
        function pro=mfvl_pro_cdr_11(mesh,domain,model,degree,flux,weight,stencil_size,auto_stencil_opt)
        ...
        function rec=make_none(pro,degree,weight,cells_data,stencil_size,auto_stencil_opt)
            ...
            %%%%%%%%%%%%%
            for i=num_vertices-10:num_vertices-1
                if isempty(a_matrix_none{i-1})==1
                    a_matrix_value=[];
                else
                    a_matrix_value=a_matrix_none{i-1};
