% November, 2017
% class for mfvl_pro_25_07_17
classdef mfvl_pro_cdr_25_07_17<handle
    ...
    methods
        ...
        function pro=mfvl_pro_cdr_25_07_17(mesh,domain,model,degree,flux,weight,stencil_size,auto_stencil_opt)
        ...
        function res=make_residual(pro,degree,weight,U,vertex_data,S,a,v,r,stencil_size,auto_stencil_opt)
            ...
            if pro.get_model.get_bound_cond(2).get_type==mfvl_bound_cond_neumann
            	...
            	%res(num_cells)=pro.get_model.get_bound_cond(2).get_value(1);
