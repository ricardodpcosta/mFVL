% November, 2017
% class for mfvl_pro_cdr_c1_15_11_17
classdef mfvl_pro_cdr_c1_15_11_17<handle
    ...
    methods
        ...
        function pro=mfvl_pro_cdr_c1_15_11_17(mesh,domain,model,degree,flux,weight,stencil_size,auto_stencil_opt)
        ...
        function [f_diff,f_conv] = make_flux(pro,rec_point,rec_none,a,v)
            ...
            switch pro.flux
                case 'pro1'
                    ...
                    f_conv(1)=max(0,v(1))*pro.model.bound_cond(1).value+min(0,v(1))*rec_point{2}.eval_value(vertices_coordinates(1));
                    for i=2:num_cells
                    ...
                    f_conv(num_cells+1)=max(0,v(num_cells+1))*rec_point{num_cells+2}.eval_value(vertices_coordinates(num_cells+1))+min(0,v(num_cells+1))*rec_point{num_cells+2}.eval_value(vertices_coordinates(num_cells+1));
                case 'pro2'
                    f_diff(1)=a(1)*rec_point{1}.eval_deriv(vertices_coordinates(1),1);
                    for i=2:num_cells
