% January, 2017
% class for mfvl_pro
classdef mfvl_pro_cdr_25_07_17_c3<handle
    ...
    methods
        ...
        function pro=mfvl_pro_cdr_25_07_17_c3(mesh,domain,model,degree,flux,weight,stencil_size,auto_stencil_opt)
        ...
        function rec=make_point_value(pro,degree,weight,cells_data,vertex_data,stencil_size,auto_stencil_opt)
            ...
            %stencil_size=ceil(stencil_size_factor*degree_rec);
            rec{x}=mfvl_reconst1d(pro.mesh,...
                target_type,...
                lsm_weight,...
                degree_rec,...
