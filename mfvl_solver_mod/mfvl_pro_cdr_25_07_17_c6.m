% January, 2017
% class for mfvl_pro
classdef mfvl_pro_cdr_25_07_17_c6<handle
    ...
    methods
        ...
        function pro=mfvl_pro_cdr_25_07_17_c6(mesh,domain,model,degree,flux,weight,stencil_size,auto_stencil_opt)
        ...
        function rec=make_none(pro,degree,weight,cells_data,stencil_size,auto_stencil_opt)
            ...
            for i=2:num_vertices-1
                ...
                rec{i-1}=mfvl_reconst1d(pro.mesh,...
                    ...
                    x_bars,...
                    psi_bars,...
                    ceil(stencil_size_factor*(degree+1)),...
                    'auto',...
        ...
        function rec=make_point_value(pro,degree,weight,cells_data,vertex_data,stencil_size,auto_stencil_opt)
            ...
            rec{1}=mfvl_reconst1d(pro.mesh,...
                ...
                x_bars,...
                psi_bars,...
                ceil(stencil_size_factor*degree),...
                'user',...
                pro.simulation_scheme,...
                a_matrix_value,...
                stencil);
            ...
            rec{x}=mfvl_reconst1d(pro.mesh,...
                ...
                x_bars,...
                psi_bars,...
                ceil(stencil_size_factor*(degree+2)),...
                'user',...
                pro.simulation_scheme,...
                a_matrix_value,...
                stencil);
