% January, 2017
% class for mfvl_pro
classdef mfvl_pro_cdr_6<handle
    ...
    methods
        ...
        function pro=mfvl_pro_cdr_6(mesh,domain,model,degree,flux,weight,stencil_size,auto_stencil_opt)
