...
%             end
            ...
            if isempty(rec.psi_bars)==0
                if rec.conservation==mfvl_conservation_point_value || rec.conservation==mfvl_conservation_point_value_der1
                    B(i+1,:)=rec.lsm_weight2*rec.psi_bars;
                end
            end
            
            % B matrix -  point value conservation - last line
%             if rec.conservation==mfvl_conservation_point_value
%                 B(i+1,:)=rec.lsm_weight2*rec.psi_bars;
%             end
        end
        ...
        function R=make_lsm_coefs(rec,scheme)
            ...
            switch scheme
                case mfvl_cdr_scheme
                    if (rec.conservation==mfvl_conservation_point_value_der1 || rec.conservation==mfvl_conservation_point_value)
                ...
                otherwise
                    ...
                    if strcmp(scheme,'pro1')==1
                        if (rec.conservation==mfvl_conservation_mean_value_der1 || rec.conservation==mfvl_conservation_mean_value_der2 || rec.conservation==mfvl_conservation_none_der1 || rec.conservation==mfvl_conservation_none_der2)
                            R = lsqlin(var1,var2,[],[],var3,var4);
                        else
                            R=lsqlin(A,B);
                        end
